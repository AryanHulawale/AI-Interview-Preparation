...
import ProfileCardInfo from "../components/Cards/ProfileInfoCard.jsx"
...
const LandingPage = () => {
  ...
  return (
    <>
      <div className="w-full min-h-full bg-[#FFFCEF] pt-0 ">
          ...
          <div className="flex flex-col md:flex-row items-center ">
            <div className="w-full md:w-1/2 pr-4 mb-8 md:mb-0">
              ...
              <h1 className="text-5xl text-black font-medium mb-6 leading-tight">
                ...
                <span className='text-transparent bg-clip-text bg-[radial-gradient(circle,_#FF9324_0%,_#FCB760_100%)] bg-[length:200%_200%] font-semibold animate-text-shine'>AI Powered </span>{""}
                Learning
              </h1>
            </div>
            <div className="w-full md:w-1/2">
              ...
              <button className='text-white bg-black text-sm font-semibold px-7 py-2.5 rounded-full hover:bg-yellow-100 hover:text-black border border-yellow-50 hover:border-yellow-300 transition-colors cursor-pointer'
                onClick={handleCTA}>
                Get Started
              </button>
            </div>
      ...
      <div className="w-full min-h-full relative z-10">
        <div className="">
          <section className='flex items-center justify-center -mt-36 '>
            <img src={HERO_IMG} alt="Hero Image" className='rounded-lg w-[80vw]' />
          </section>
        </div>
      </div>
      <div className="w-full min-h-full bg-[#FFFCEF] mt-15">
        ...
        <div className="text-sm bg-gray-50 text-secondary text-center p-5 mt-20">
