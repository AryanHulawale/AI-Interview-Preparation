    ...
    return (
      <div className="p-4 border border-yellow-200 bg-yellow-50 rounded-md">
        <p className="text-yellow-700">
          The AI response is being formatted. If this takes too long, please try regenerating the explanation.
        </p>
      </div>
    );
  }
      ...
      <div className="text-[14px] prose prose-slate dark:prose-invert max-w-none">
        <ReactMarkdown
          ...
          components={{
            ...
            th({ children }) {
              return <th className="px-3 py-2 font-medium text-xs text-left text-gray-500 uppercase tracking-wider">{children}</th>;
            },
            td({ children }) {
...
function CodeBlock({ code, language }) {
  ...
  return (
    <div className="relative my-6 border border-gray-200 rounded-lg overflow-hidden bg-gray-50">
